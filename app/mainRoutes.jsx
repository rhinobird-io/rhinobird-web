...
module.exports = (
    <Route name="app" path="/platform" handler={require("./components/Application")}>
        ...
        <Route name="activity" path="activity" handler={require("react-router-proxy!./components/Activity")}>
            <Route name="speech-detail" path="activities/:id" handler={require("react-proxy!./components/Activity/SpeechDetail")} />
            <Route name="create-speech" path="create-activity" handler={require("react-proxy!./components/Activity/SpeechDetail/SpeechEdit")} />
            <Route name="edit-speech" path="edit-activity/:id" handler={require("react-proxy!./components/Activity/SpeechDetail/SpeechEdit")} />
            ...
            <Route name="exchange-list" path="exchanges" handler={require("react-proxy!./components/Activity/ExchangeCenter/Exchanges")} />
